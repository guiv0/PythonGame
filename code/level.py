...
from code.const import C_L_CREAM, WIN_HEIGHT, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, C_GREEN, C_CYAN
...
class Level:
    ...
    def run(self):
        ...
        while True:
            ...
            self.level_text(f'entidades: {len(self.entity_list)}', C_L_CREAM, (10, WIN_HEIGHT - 20))
            pygame.display.flip()
